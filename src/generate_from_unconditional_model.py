...
from src.commons import SAMPLE_RATE, SF2_PATH, decode, note_sequence_to_tonejs_midi_json

# parser = argparse.ArgumentParser()
# parser.add_argument(
#     "-o", "--output_dir", type=str, required=True, help="Midi output directory."
# )
# parser.add_argument(
#     "-p",
#     "--primer",
...
def generate_from_unconditional_model(primer=None, max_primer_seconds=20):
    ...
    if primer is None:
        return note_sequence_to_tonejs_midi_json(
            generate_ns_from_scratch(
                estimator,
                ckpt_path,
